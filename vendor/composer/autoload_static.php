...
class ComposerStaticInit8314759a6318bf6ce9df881f24d5cd1a
{
    public static $classMap = array (
        'Abstract_Lokalise_Callback' => __DIR__ . '/../..' . '/include/Callback/class-abstract-lokalise-callback.php',
        'Abstract_Lokalise_Decorator' => __DIR__ . '/../..' . '/include/Decorator/class-abstract-lokalise-decorator.php',
        ...
        'Lokalise_Decorator_Polylang' => __DIR__ . '/../..' . '/include/Decorator/class-lokalise-decorator-polylang.php',
        'Lokalise_Decorator_Wpml' => __DIR__ . '/../..' . '/include/Decorator/class-lokalise-decorator-wpml.php',
        'Lokalise_Field_Provisioner' => __DIR__ . '/../..' . '/include/lokalise-field-provisioner.php',
        'Lokalise_Field_ProvisionerProvider' => __DIR__ . '/../..' . '/include/class-lokalise-field-provisioner-provider.php',
        'Lokalise_Field_Provisioner_Acf' => __DIR__ . '/../..' . '/include/FieldProvisioner/class-lokalise-field-provisioner-acf.php',
        ...
        'Lokalise_Locales_Polylang' => __DIR__ . '/../..' . '/include/Locales/class-lokalise-locales-polylang.php',
        ...
        'Lokalise_Provider_Polylang' => __DIR__ . '/../..' . '/include/Provider/class-lokalise-provider-polylang.php',
        ...
        'Lokalise_Router' => __DIR__ . '/../..' . '/include/Routing/class-lokalise-router.php',
        'Lokalise_Routes' => __DIR__ . '/../..' . '/include/Routing/class-lokalise-routes.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInit8314759a6318bf6ce9df881f24d5cd1a::$classMap;
